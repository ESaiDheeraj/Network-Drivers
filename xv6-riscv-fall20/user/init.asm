...
free(void *ap)
{
 ...
 722:	1ea7b783          	ld	a5,490(a5) # 908 <freep>
 ...
 750:	00e6ea63          	bltu	a3,a4,764 <free+0x50>
{
 ...
 792:	16f73d23          	sd	a5,378(a4) # 908 <freep>
}
 796:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7c4:	14853503          	ld	a0,328(a0) # 908 <freep>
 ...
 7ec:	12090913          	addi	s2,s2,288 # 908 <freep>
  if(p == (char*)-1)
 7f0:	5afd                	li	s5,-1
 ...
 800:	10f73623          	sd	a5,268(a4) # 908 <freep>
 804:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 826:	0ea73323          	sd	a0,230(a4) # 908 <freep>
      return (void*)(p + 1);
